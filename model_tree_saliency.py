...
class DecoderRNN_b(nn.Module):
    ...
    def sample(self, inputs, states=None, max_len=20, threshold = 0.5):
        ...
        def lstm_rec(self,inputs, states, m_len,output_scores, caption, current,current_output, threshold=0.5):
            ...
            if caption and (caption[-1] == 12 or caption[-1] == 1):
                ...
                yield {clean_sentence(caption) : output_scores}
            ...
            if m_len > 0 and len(caption) < 20:
                ...
                for target in targets:
                    ...
                    yield from lstm_rec(self, inputs, states, m_len,output_scores.copy(), copy.deepcopy(caption), target.item(),outputs, threshold)

        return lstm_rec(self,inputs, states, max_len,[], [], None, None, threshold=0.7)