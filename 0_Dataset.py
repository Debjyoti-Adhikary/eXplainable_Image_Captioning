...
# dataDir = 'cocoapi'
# dataType = 'val2017'
# instances_annFile = os.path.join(os.getcwd(),dataDir, 'annotations\instances_{}.json'.format(dataType))
...
captions_annFile = os.path.join(os.getcwd(), dataDir, 'annotations\captions_{}.json'.format(dataType))
