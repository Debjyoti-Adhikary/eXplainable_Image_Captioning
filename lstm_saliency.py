...
class Saliency():
    def __init__(self,encoder, decoder,input_size =(224,224)):
    ...
    def forward(self, raw_input):
        ...
        caption,logits,_ = self.decoder.sample(v_features.to('cuda'))
        saliency_maps = []
        # print(logits)
        # print(torch.equal(logits[1][0],logits[1][1]))
        #logit = logits[1][5]  ## generate for all the time stamps and save
        # print(logits[0])
        for logit in logits:
        ...
        # print([*self.decoder.children()][3].grad)
        # score.detach()
        # print(torch.equal(activations,self.activations['value']))
            gradients = self.gradients['value']
            activations = self.activations['value']
        # print(f'{gradients.size()}')
...
class GradCAM():
    ...
    def __init__(self, model_dict, verbose=False):
        ...
        elif 'others' in model_type.lower():
            target_layer = find_other_layer(self.model_arch, layer_name)
