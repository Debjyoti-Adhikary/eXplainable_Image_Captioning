...
class EncoderCNN_v1(nn.Module):
    def __init__(self, embed_size,input_length, modules):
        """Load the pretrained ResNet152 and replace top fc layer."""
        super(EncoderCNN_v1, self).__init__()
        ...
        # modules.pop(-2)
        # modules.pop(7)
        # input_length = 1024 #64 #256 #512 #1024 #resnet.fc.in_features
...
class DecoderRNN_v1(nn.Module):
    def __init__(self, embed_size, hidden_size, vocab_size, num_layers=1):
        ...
        """
        super(DecoderRNN_v1, self).__init__()
